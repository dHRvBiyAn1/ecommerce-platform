...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        // Rubik = display: geometric, modern, distinctive (per ui-ux-pro-max skill)
        // Nunito Sans = body: refined, readable
        // Mono kept distinctive (JetBrains Mono not Fira Code default)
